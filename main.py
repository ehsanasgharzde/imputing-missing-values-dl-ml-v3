...
iterimp = IterativeImputer(estimator=linreg, n_nearest_features=5, max_iter=5000, tol=1e-12, verbose=2)
...
########## Creating a csv file
micedataset.to_csv("multivariate-method-results/AMR-and-NSH-Buoy-Data1394-normalized-mice-linear-regression.csv")